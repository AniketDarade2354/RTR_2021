...
int main(void)
{
	...
	printf("2nd Element Of Array 'iArrayTwo[]' Or Element At 1th Index Of Array 'iArrayTwo[]' = %d\n",iArrayTwo[1]);
	printf("3rd Element Of Array 'iArrayTwo[]' Or Element At 2th Index Of Array 'iArrayTwo[]' = %d\n",iArrayTwo[2]);
	printf("4th Element Of Array 'iArrayTwo[]' Or Element At 3th Index Of Array 'iArrayTwo[]' = %d\n",iArrayTwo[3]);
