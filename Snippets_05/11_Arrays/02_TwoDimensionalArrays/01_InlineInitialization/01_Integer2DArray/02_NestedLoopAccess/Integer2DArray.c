...
int main(void)
{
	...
	int int_size;
	int iArray_size;
	int iArray_num_elemenets, iArray_num_rows, iArray_num_columns;
	int i,j;
	...
	iArray_num_elemenets = iArray_num_rows * iArray_num_columns;
	printf("Number of Elements In Two Dimensional (2D) Integer Array Is = %d\n\n",iArray_num_elemenets);
