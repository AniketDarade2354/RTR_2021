...
int main(void)
{
	...
	// *** A 'STRING' IS AN ARRAY OF CHARACTERS ... so char[] IS A 'STRING' ***
	...
	int iStrLengths[10];//1D Integer Array = Stores lengths of those strings at corressponding indices in 'strArray[]' e.g: iStrLengths[0] will be the length of string at strArray[0],strArray[1] will be the length of string at strArray[1]...10strings, 10 lengths...
	int strArray_size;
