...
int main(void)
{
	...
	// Here, the string array can allow can allow a maximum number of 10 strings (10 rows) and each of these 10 strings can have only upto 15 characters maximum (15 columns)
	...
	printf("Number of Rows (Strigs) In Two Dimensional ( 2D ) Character Array (String Array) Is = %d\n\n",strArray_num_rows);
