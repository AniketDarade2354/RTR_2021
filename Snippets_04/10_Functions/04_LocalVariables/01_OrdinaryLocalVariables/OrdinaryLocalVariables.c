...
int main(void)
{
	...
	// Since, 'local_count' is an ordinary local variable of change_count(), it will NOT retain its value from previous call to chnage_count().
...
void change_count(void)
{
	// *** LOCAL SCOPE OF chnage_count() begins ***

	//variable declarations
	//'local_count' is a Local Variable. It is loacl to change_count() only.
	int local_count = 0;
	 //code
