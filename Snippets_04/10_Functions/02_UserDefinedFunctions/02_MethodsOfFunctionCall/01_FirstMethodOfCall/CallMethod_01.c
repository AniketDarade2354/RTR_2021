...
// ******** USER DEFINIED FUNCTIONS : METHOD OF CALLING FUNCTION 1 *******
// ******** CALLING ALL FUNCTIONS IN main() DIRECTLY *****

//Entry-Point Function => main() => Valid Return Type (int) and 3 Parameters int(int argc,char *argv[],char *envp[])
int main(int argc, char* argv[], char* envp[])
{
	...
	// *** DIVIDION ***
	printf("\n\n");
	printf("Enter Integer For 'A' For Division : ");
	scanf("%d", &a_division);
...
int MySubtraction(void)
{
	//variable declarations : local variable yo MySubtraction()
	int a, b, subtraction;
...
{
	//variable declarations : loacl variables to MyDivision()
