// *** GLOBAL SCOPE ***
// global_count is a global variable declared in source code file ExternalGloabalVariablesInMultipleFiles.c
// To access it in this file along with the 'extern' keyword and its proper data type
